...
namespace UD.Cameras
{
    public class ProtectCameraFromWallClip : MonoBehaviour
    {
        ...
        {
            var targetDist = originalDist;
            var nearest = Mathf.Infinity;
            var hasSmoothing = false;
            var length = Physics.RaycastNonAlloc(pivot.position, -pivot.forward, hitInfos, originalDist, checkLayerMask);
            ...
            var smoothTime = currentDist > targetDist ? clipMoveTime : returnTime;
